<script setup lang="ts">
  ...
  if (resp.status === 200) {
    ...
    policyData.value = {
      ...
      screenCaptureDisabled: policyFromApi.screenCaptureDisabled,
      smsDisabled: policyFromApi.smsDisabled,
      bluetoothDisabled: policyFromApi.bluetoothDisabled,
      factoryResetDisabled: policyFromApi.factoryResetDisabled,
      modifyAccountsDisabled: policyFromApi.modifyAccountsDisabled,
      ...
      deviceConnectivityManagement: {
        ...
        bluetoothSharing: policyFromApi.deviceConnectivityManagement.bluetoothSharing
      },
  ...
  const isSsidRestrictionEnabled = computed({
    ...
    set: (value: boolean) => {
      ...
      policyData.value.deviceConnectivityManagement.wifiSsidPolicy.wifiSsids = value ? (resp.json.policy.deviceConnectivityManagement.wifiSsidPolicy.wifiSsids ?? [{wifiSsid: ''}]) : []
    }
  })
